export const generateInvoiceEmailTemplate = (
  ...
  const showroomLogo = `http://localhost:3000/uploads/${showroom.images[0]}`;
      ...
      <body>
        <div class="container">
          <div class="header">
            ...
            <h1 style="font-size: 24px; margin: 0;">${showroom.showroomName || "Showroom"}</h1>
            <h1>Car Maintenance Started</h1>
          </div>
          <div class="content">
            ...
            <div class="details">
              ...
              <p><strong>Total Cost (including rent cost):</strong> PKR ${Number(rentalTotal || 0).toFixed(2)}</p>
            </div>
            <p>Thank you for choosing our service. If you have any questions, feel free to contact us.</p>
          </div>
          <div class="footer">
            <p>Showroom Team © ${new Date().getFullYear()}</p>
